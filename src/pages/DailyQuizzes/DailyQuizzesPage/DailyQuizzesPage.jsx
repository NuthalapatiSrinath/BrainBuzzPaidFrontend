...
import SearchBar from "../../../components/SearchBar/SearchBar"; // <- use your SearchBar component
  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      <section className={styles.categories}>
        ...
        {/* SEARCH BAR (using your SearchBar component, working) */}
        ...
        <div className={`${styles.grid} ${search ? styles.searchActive : ""}`}>
          {filtered.map((cat) => (
            <div
              ...
              aria-label={`Go to ${cat.name} quizzes`}
            >
          ...
          {/* optional: show "no results" if filtered is empty */}
          {filtered.length === 0 && (
